...
- 通常の repo: `{{PYTHON_LAUNCHER}} scripts/run-codex-impl-cycle.py`
- dotfiles repo 直作業: `{{PYTHON_LAUNCHER}} scripts/run-codex-impl-cycle.py`
...
```text
{{PYTHON_LAUNCHER}} scripts/run-codex-impl-cycle.py --cycle-type alignment --files <files...> --include-files <deps...>
{{PYTHON_LAUNCHER}} scripts/run-codex-impl-cycle.py --cycle-type verification --files <files...> --include-files <deps...>
{{PYTHON_LAUNCHER}} scripts/run-codex-impl-cycle.py --cycle-type quality --files <files...> --include-files <deps...>
```
